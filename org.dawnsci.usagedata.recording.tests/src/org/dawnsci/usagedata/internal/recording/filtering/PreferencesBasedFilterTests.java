...
public class PreferencesBasedFilterTests {
	...
	public void setup() {
		...
		getPreferencesStore().setToDefault(UsageDataRecordingSettings.FILTER_NON_BUNDLE_EVENT_ONLY_KEY);
	...
	@Test
	public void testSetDAWNOnly() {
		assertFalse(getPreferencesStore().getBoolean(UsageDataRecordingSettings.FILTER_NON_BUNDLE_EVENT_ONLY_KEY));	
		filter.setNonBundleEventOnly(true);
		assertTrue(getPreferencesStore().getBoolean(UsageDataRecordingSettings.FILTER_NON_BUNDLE_EVENT_ONLY_KEY));	
	}

	@Test
	public void testIsDAWNOnly() {
		assertTrue(filter.isNonBundleEventOnly()); // Default
		getPreferencesStore().setValue(UsageDataRecordingSettings.FILTER_NON_BUNDLE_EVENT_ONLY_KEY, false);	
		assertFalse(filter.isNonBundleEventOnly());
	}
