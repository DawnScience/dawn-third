...
import org.dawnsci.usagedata.internal.gathering.settings.UsageDataCaptureSettings;
...
public class UsageDataRecordingSettings implements UploadSettings {
	...
	public static final String FILTER_NON_BUNDLE_EVENT_ONLY_KEY = UsageDataRecordingActivator.PLUGIN_ID + ".filter-nonbundle-only"; //$NON-NLS-1$
	...
	static final boolean ASK_TO_UPLOAD_DEFAULT = false;
	...
	/* (non-Javadoc)
	 * @see org.dawnsci.usagedata.internal.recording.settings.UploadSettings#getFilter()
	 */
	...
	/* (non-Javadoc)
	 * @see org.dawnsci.usagedata.internal.recording.settings.UploadSettings#hasUserAcceptedTermsOfUse()
	 */
	...
	private UsageDataCaptureSettings getCaptureSettings() {
		return org.dawnsci.usagedata.internal.gathering.UsageDataCaptureActivator.getDefault().getSettings();
	}

	/* (non-Javadoc)
	 * @see org.dawnsci.usagedata.internal.recording.settings.UploadSettings#isEnabled()
	 */
