...
public class H4File extends FileFormat {
    ...
    private int fid; // overlays long version
    ...
    public TreeNode copy(HObject srcObj, Group dstGroup, String dstName)
        ...
        log.trace("copy(): dstName={}", dstName);
    ...
    public void writeAttribute(HObject obj, Attribute attr,
        ...
        int attrType = (int) attr.getType().toNative();
        ...
        log.trace("writeAttribute(): start count={}", count);
