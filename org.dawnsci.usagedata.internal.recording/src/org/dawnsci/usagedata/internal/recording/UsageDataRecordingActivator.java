...
import org.dawnsci.usagedata.internal.recording.uploading.UploadManager;
...
public class UsageDataRecordingActivator extends AbstractUIPlugin implements IStartup {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.dawnsci.usagedata.recording"; //$NON-NLS-1$
	...
	public void start(BundleContext context) throws Exception {
		 ...
		 * org.dawnsci.usagedata.capture bundle, we can be sure that the UsageDataService
